...
/*global markCheckedAllElements, validateNumber, setWindowElementFocus, showJSMessage, inputValue,openServletNewWindow, getReadyStateHandler,
  ...
  resizeArea, updateMenuIcon,displayLogicElement, resizeArea ,setBrowserAutoComplete, getFrame*/
OB = {};
OB.Aging = {};
...
function printPDF() {
  if (validate()) {
    ...
    var details = document.frmMain.inpDetails.checked,
        ...
        voidexclude = document.frmMain.inpVoid.checked,
    ...
    openServletNewWindow('PRINT_PDF', true, url + '?inpBPartnerId_IN=' + BPartnerString + '&inpDetails=' + details + '&inpDoubtful=' + doubtful + '&inpVoid=' + voidexclude, 'AgingInquiry', null, false, '700', '1000', true);
    return false;
  }
  return true;
}
...
function printXLS() {
  if (validate()) {
    ...
    openServletNewWindow('PRINT_XLS', true, url + '?inpBPartnerId_IN=' + BPartnerString + '&inpDetails=' + details + '&inpDoubtful=' + doubtful + '&inpVoid=' + voidexclude, 'AgingInquiry', null, false, '700', '1000', true);
    return false;
  }
  return true;
}
...
function getAgingBalanceData() {
  ...
  top.OB.ViewManager.openView('OBClassicWindow', {
    ...
    obManualURL: '/org.openbravo.agingbalance/ad_reports/' + url + '?inpOrg=' + organization + '&inpAccSchema=' + acctSchema + '&inpBPartnerId_IN=' + BPartnerString + '&inpCurrentDate=' + currentDate + '&inpColumn1=' + column1 + '&inpColumn2=' + column2 + '&inpColumn3=' + column3 + '&inpColumn4=' + column4 + '&inpDetails=' + details + '&inpDoubtful=' + doubtful + '&inpVoid=' + voidexclude + '&vScroll=auto',
    command: 'DIRECT',
...
function onLoadDo() {
  ...
  if (f.OB.PropertyStore.get('AGING_ShowVoidCheckbox') === 'Y') {
    displayLogicElement('showexcludevoided_section', true);
    document.frmMain.inpVoid.checked = true;
  } else {
