...
public class AgingProcess extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strVoid = vars.getGlobalVariable("inpVoid", "AgingInquiry|void", "true");
      ...
      String strVoid;
      try {
        strVoid = Preferences.getPreferenceValue("AGING_ShowVoidCheckbox", true,
            OBContext.getOBContext().getCurrentClient(),
            OBContext.getOBContext().getCurrentOrganization(), OBContext.getOBContext().getUser(),
            OBContext.getOBContext().getRole(), null).equals("Y") ? vars.getRequestGlobalVariable(
            "inpVoid", "AgingInquiry|void") : "true";
      } catch (Exception ex) {
        strVoid = "true";
      }
  ...
  private void printPageSchedule(final HttpServletRequest request, HttpServletResponse response,
      ...
      String strcolumn4, String strOutput, String recOrPay, String strDoubtful, String strVoid)
  ...
  private void printPageDetails(final HttpServletRequest request, HttpServletResponse response,
      ...
      String strcolumn2, String strcolumn3, String strcolumn4, String strDoubtful, String strVoid)
      throws IOException, ServletException {
    ...
    try {
      ...
      OBContext.setAdminMode(true);
      try {
        bPartners = OBDao.getOBObjectListFromString(BusinessPartner.class, strcBpartnerId);
        if (strAccSchema == null || "".equals(strAccSchema)) {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strDetails, String strDoubtful, String strVoid) throws IOException, ServletException {
