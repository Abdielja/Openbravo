...
static Logger log4j = Logger.getLogger(LinesData.class);
  ...
  public String emObposQtydeleted;
  ...
  public String emObposServiceProposed;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return qtyordered;
    else if (fieldName.equalsIgnoreCase("em_obpos_qtydeleted") || fieldName.equals("emObposQtydeleted"))
      return emObposQtydeleted;
    ...
    else if (fieldName.equalsIgnoreCase("em_obpos_service_proposed") || fieldName.equals("emObposServiceProposed"))
      return emObposServiceProposed;
 ...
 */
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cOrderId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "C_OrderLine.EM_Obpos_Qtydeleted, " +
      ...
      "COALESCE(C_OrderLine.EM_Obpos_Isdeleted, 'N') AS EM_Obpos_Isdeleted, " +
      ...
      "COALESCE(C_OrderLine.EM_Obpos_Service_Proposed, 'N') AS EM_Obpos_Service_Proposed, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLinesData.emObposQtydeleted = UtilSql.getValue(result, "em_obpos_qtydeleted");
        ...
        objectLinesData.emObposIsdeleted = UtilSql.getValue(result, "em_obpos_isdeleted");
        ...
        objectLinesData.emObposServiceProposed = UtilSql.getValue(result, "em_obpos_service_proposed");
 ...
 */
  public static LinesData[] set(String cOrderId, String lineGrossAmount, String cancelpricead, String cOrderlineId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String line, String dateordered, String datepromised, String datedelivered, String dateinvoiced, String description, String mProductId, String mProductIdr, String cUomId, String mWarehouseId, String qtyordered, String qtyreserved, String qtydelivered, String qtyinvoiced, String mShipperId, String cCurrencyId, String pricelist, String priceactual, String cTaxId, String cBpartnerId, String directship, String freightamt, String cChargeId, String chargeamt, String relateOrderline, String cBpartnerLocationId, String linenetamt, String pricelimit, String discount, String emObposServiceProposed, String cCostcenterId, String printDescription, String cReturnReasonId, String sResourceassignmentId, String cOrderDiscountId, String user2Id, String aAssetId, String emObposQtydeleted, String overdueReturnDays, String refOrderlineId, String iseditlinenetamt, String taxbaseamt, String mProductUomId, String quantityorder, String mOfferId, String pricestd, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String user1Id, String isdescription, String bomParentId, String grosspricestd, String explode, String mInoutlineId, String cProjectId, String cProjectIdr, String grosspricelist, String mWarehouseRuleId, String createReservation, String soResStatus, String manageReservation, String managePrereservation, String emObposIsdeleted, String quotationlineId, String quotationlineIdr, String grossUnitPrice)    throws ServletException {
    ...
    objectLinesData[0].emObposQtydeleted = emObposQtydeleted;
    ...
    objectLinesData[0].emObposIsdeleted = emObposIsdeleted;
    ...
    objectLinesData[0].emObposServiceProposed = emObposServiceProposed;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_OrderLine" +
      "        SET Line = TO_NUMBER(?) , M_Product_ID = (?) , M_Inoutline_ID = (?) , QtyOrdered = TO_NUMBER(?) , EM_Obpos_Qtydeleted = TO_NUMBER(?) , M_AttributeSetInstance_ID = (?) , C_UOM_ID = (?) , C_Return_Reason_ID = (?) , PriceActual = TO_NUMBER(?) , Gross_Unit_Price = TO_NUMBER(?) , GrossPriceList = TO_NUMBER(?) , Discount = TO_NUMBER(?) , LineNetAmt = TO_NUMBER(?) , Line_Gross_Amount = TO_NUMBER(?) , C_Tax_ID = (?) , PriceList = TO_NUMBER(?) , M_Warehouse_Rule_ID = (?) , Description = (?) , EM_Obpos_Isdeleted = (?) , Create_Reservation = (?) , Taxbaseamt = TO_NUMBER(?) , QtyInvoiced = TO_NUMBER(?) , QtyDelivered = TO_NUMBER(?) , DateOrdered = TO_DATE(?) , DatePromised = TO_DATE(?) , M_Warehouse_ID = (?) , QtyReserved = TO_NUMBER(?) , M_Shipper_ID = (?) , C_BPartner_ID = (?) , DirectShip = (?) , FreightAmt = TO_NUMBER(?) , C_BPartner_Location_ID = (?) , CANCELPRICEAD = (?) , M_Product_Uom_Id = (?) , QuantityOrder = TO_NUMBER(?) , PriceStd = TO_NUMBER(?) , grosspricestd = TO_NUMBER(?) , Iseditlinenetamt = (?) , SO_Res_Status = (?) , Quotationline_ID = (?) , Manage_Reservation = (?) , Print_Description = (?) , Overdue_Return_Days = TO_NUMBER(?) , EM_Obpos_Service_Proposed = (?) , AD_Org_ID = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , User1_ID = (?) , User2_ID = (?) , Explode = (?) , BOM_Parent_ID = (?) , Relate_Orderline = (?) , C_OrderLine_ID = (?) , Manage_Prereservation = (?) , C_Order_Discount_ID = (?) , M_Offer_ID = (?) , IsDescription = (?) , Ref_OrderLine_ID = (?) , S_ResourceAssignment_ID = (?) , PriceLimit = TO_NUMBER(?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , C_Currency_ID = (?) , DateInvoiced = TO_DATE(?) , DateDelivered = TO_DATE(?) , C_Order_ID = (?) , IsActive = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_OrderLine.C_OrderLine_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emObposQtydeleted);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emObposServiceProposed);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Line, M_Product_ID, M_Inoutline_ID, QtyOrdered, EM_Obpos_Qtydeleted, M_AttributeSetInstance_ID, C_UOM_ID, C_Return_Reason_ID, PriceActual, Gross_Unit_Price, GrossPriceList, Discount, LineNetAmt, Line_Gross_Amount, C_Tax_ID, PriceList, M_Warehouse_Rule_ID, Description, EM_Obpos_Isdeleted, Create_Reservation, Taxbaseamt, QtyInvoiced, QtyDelivered, DateOrdered, DatePromised, M_Warehouse_ID, QtyReserved, M_Shipper_ID, C_BPartner_ID, DirectShip, FreightAmt, C_BPartner_Location_ID, CANCELPRICEAD, M_Product_Uom_Id, QuantityOrder, PriceStd, grosspricestd, Iseditlinenetamt, SO_Res_Status, Quotationline_ID, Manage_Reservation, Print_Description, Overdue_Return_Days, EM_Obpos_Service_Proposed, AD_Org_ID, C_Project_ID, C_Costcenter_ID, A_Asset_ID, User1_ID, User2_ID, Explode, BOM_Parent_ID, Relate_Orderline, C_OrderLine_ID, Manage_Prereservation, C_Order_Discount_ID, M_Offer_ID, IsDescription, Ref_OrderLine_ID, S_ResourceAssignment_ID, PriceLimit, C_Charge_ID, ChargeAmt, C_Currency_ID, DateInvoiced, DateDelivered, C_Order_ID, IsActive, AD_Client_ID, created, createdby, updated, updatedBy)" +
