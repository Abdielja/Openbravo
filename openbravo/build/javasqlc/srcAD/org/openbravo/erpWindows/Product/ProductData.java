...
static Logger log4j = Logger.getLogger(ProductData.class);
  ...
  public String emObposShowChDesc;
  public String emObposAllowanonymoussale;
  ...
  public String emObposProposalType;
  public String emObposProposalTyper;
  public String emObposIsmultiselectable;
  ...
  public String emObposPrintservices;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_obpos_show_ch_desc") || fieldName.equals("emObposShowChDesc"))
      return emObposShowChDesc;
    else if (fieldName.equalsIgnoreCase("em_obpos_allowanonymoussale") || fieldName.equals("emObposAllowanonymoussale"))
      return emObposAllowanonymoussale;
    ...
    else if (fieldName.equalsIgnoreCase("em_obpos_proposal_type") || fieldName.equals("emObposProposalType"))
      return emObposProposalType;
    else if (fieldName.equalsIgnoreCase("em_obpos_proposal_typer") || fieldName.equals("emObposProposalTyper"))
      return emObposProposalTyper;
    else if (fieldName.equalsIgnoreCase("em_obpos_ismultiselectable") || fieldName.equals("emObposIsmultiselectable"))
      return emObposIsmultiselectable;
    ...
    else if (fieldName.equalsIgnoreCase("em_obpos_printservices") || fieldName.equals("emObposPrintservices"))
      return emObposPrintservices;
 ...
 */
  public static ProductData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "COALESCE(M_Product.EM_Obpos_Show_Ch_Desc, 'N') AS EM_Obpos_Show_Ch_Desc, " +
      "COALESCE(M_Product.EM_OBPOS_AllowAnonymousSale, 'N') AS EM_OBPOS_AllowAnonymousSale, " +
      ...
      "M_Product.EM_Obpos_Proposal_Type, " +
      "(CASE WHEN M_Product.EM_Obpos_Proposal_Type IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(list11.name),'') ) END) AS EM_Obpos_Proposal_TypeR, " +
      "COALESCE(M_Product.EM_Obpos_Ismultiselectable, 'N') AS EM_Obpos_Ismultiselectable, " +
      ...
      "COALESCE(M_Product.EM_Obpos_Printservices, 'N') AS EM_Obpos_Printservices, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductData.emObposShowChDesc = UtilSql.getValue(result, "em_obpos_show_ch_desc");
        objectProductData.emObposAllowanonymoussale = UtilSql.getValue(result, "em_obpos_allowanonymoussale");
        ...
        objectProductData.emObposProposalType = UtilSql.getValue(result, "em_obpos_proposal_type");
        objectProductData.emObposProposalTyper = UtilSql.getValue(result, "em_obpos_proposal_typer");
        objectProductData.emObposIsmultiselectable = UtilSql.getValue(result, "em_obpos_ismultiselectable");
        ...
        objectProductData.emObposPrintservices = UtilSql.getValue(result, "em_obpos_printservices");
...
Create a registry
 */
  public static ProductData[] set(String mProductId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String name, String description, String issummary, String cUomId, String isstocked, String ispurchased, String issold, String volume, String weight, String revplantype, String quantityRule, String value, String mProductCategoryId, String cTaxcategoryId, String upc, String sku, String shelfwidth, String shelfheight, String shelfdepth, String unitsperpallet, String discontinued, String discontinuedby, String defaultperiod, String allowDeferredSell, String emObposAllowanonymoussale, String emObposProposalType, String relateprodtoservice, String documentnote, String help, String classification, String emObposShowstock, String salesrepId, String bookusingpoprice, String isbom, String isinvoiceprintdetails, String ispicklistprintdetails, String isverified, String processing, String islinkedtoproduct, String emObposIsmultiselectable, String capacity, String delaymin, String mrpPlannerId, String mrpPlanningmethodId, String qtymax, String qtymin, String qtystd, String qtytype, String stockmin, String productSelection, String uniquePerDocument, String overdueReturnDays, String relateprodcattoservice, String emObposScale, String sExpensetypeId, String sResourceId, String ispricerulebased, String producttype, String imageurl, String descriptionurl, String versionno, String guaranteedays, String deferredSellMaxDays, String attrsetvaluetype, String adImageId, String cBpartnerId, String ispriceprinted, String name2, String costtype, String coststd, String stockMin, String enforceAttribute, String calculated, String maProcessplanId, String production, String isdeferredrevenue, String mAttributesetId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String downloadurl, String emObposPrintservices, String mFreightcategoryId, String mLocatorId, String isdeferredexpense, String emObposGroupedproduct, String printDescription, String prodCatSelection, String defaultperiodExp, String expplantype, String periodnumberExp, String updateinvariants, String returnable, String mBrandId, String isgeneric, String genericProductId, String emObposShowChDesc, String createvariants, String characteristicDesc, String managevariants, String cUomWeightId, String isquantityvariable, String periodnumber)    throws ServletException {
    ...
    objectProductData[0].emObposShowChDesc = emObposShowChDesc;
    objectProductData[0].emObposAllowanonymoussale = emObposAllowanonymoussale;
    ...
    objectProductData[0].emObposProposalType = emObposProposalType;
    objectProductData[0].emObposProposalTyper = "";
    objectProductData[0].emObposIsmultiselectable = emObposIsmultiselectable;
    ...
    objectProductData[0].emObposPrintservices = emObposPrintservices;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emObposShowChDesc);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emObposAllowanonymoussale);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emObposProposalType);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emObposIsmultiselectable);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emObposPrintservices);
