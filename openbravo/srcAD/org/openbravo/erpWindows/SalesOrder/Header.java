...
comboTableData = new ComboTableData(vars, this, "18", "EM_Obpos_Applications_ID", "F523B357A94B43F68C414707BA45C785", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emObposApplicationsId"):dataField.getField("emObposApplicationsId")));
xmlDocument.setData("reportEM_Obpos_Applications_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
xmlDocument.setParameter("validuntil_Format", vars.getSessionValue("#AD_SqlDateFormat"));
xmlDocument.setParameter("EM_Obdisc_Addpack_BTNname", Utility.getButtonName(this, vars, "A02DE0950D394BA7B04D53CEF919E1C4", "EM_Obdisc_Addpack_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Obdisc_Addpack = org.openbravo.erpCommon.utility.Utility.isModalProcess("C59D80628EAC461CA227D7ABAD089FA0"); 
xmlDocument.setParameter("EM_Obdisc_Addpack_Modal", modalEM_Obdisc_Addpack?"true":"false");
xmlDocument.setParameter("EM_Obpos_Createdabsolute_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("EM_Obpos_Createdabsolute_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
